...
def generate_launch_description():
    pkg_name = 'diff_bot'
    pkg_share = launch_ros.substitutions.FindPackageShare(package='diff_bot').find('diff_bot')
    default_model_path = os.path.join(pkg_share, 'src/description/diff_bot.urdf')
